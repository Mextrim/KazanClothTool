...
namespace grzyClothTool.Controls
{
    ...
    public partial class SettingsLabelCheckBox : UserControl
    {
        ...
        .Register("Label",
                ...
                new FrameworkPropertyMetadata("Без названия"));
        ...
        private void CheckBox_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                CustomMessageBoxResult result = Show(DisplayWarning, "Предупреждение", CustomMessageBoxButtons.OKCancel, CustomMessageBoxIcon.Warning);
