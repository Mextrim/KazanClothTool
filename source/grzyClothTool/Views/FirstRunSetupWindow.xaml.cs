...
namespace grzyClothTool.Views
{
    ...
    public partial class FirstRunSetupWindow : Window
    {
        ...
        private void BrowseButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            dialog.Description = "Выберите ГЛАВНУЮ папку, в которой будут храниться ВСЕ проекты (не папку конкретного проекта)";
        ...
        private void ContinueButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                ValidationMessage.Text = "Перед продолжением выберите главную папку.";
            ...
            {
                ValidationMessage.Text = "Корневой диск (например, C:\\) нельзя использовать как главную папку. Выберите или создайте вложенную папку.";
                ValidationMessage.Visibility = Visibility.Visible;
                return;
            }
            ...
            {
                ValidationMessage.Text = "Доступ запрещён. Выберите папку, в которую у вас есть права записи.";
                ValidationMessage.Visibility = Visibility.Visible;
            }
            catch (Exception ex)
            {
                ValidationMessage.Text = $"Ошибка: {ex.Message}";
                ValidationMessage.Visibility = Visibility.Visible;
            }
        }
    }
