...
namespace grzyClothTool.Views
{
    ...
    public partial class OptimizeWindow : Window, INotifyPropertyChanged
    {
        ...
        private void OptimizeTexture_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Close();
                CustomMessageBox.Show("Параметры оптимизации не выбраны", "Предупреждение", Controls.CustomMessageBox.CustomMessageBoxButtons.OKOnly, Controls.CustomMessageBox.CustomMessageBoxIcon.Warning);
                return;
            }
            ...
            LogHelper.Log("Текстуры будут оптимизированы при сборке ресурса");
            Close();
        }
